...
- Radar reads only `benchmarks_index.json`; Library-only records can never enter Latest/30d/90d.
...
- Public Description and Why it matters copy is generated through the DeepSeek Chat Completions API from supplied source text and official artifact excerpts. Discovery quotes are not displayed as editorial copy.
