...
| 2 | **RA-Bench**<br><sub>[Paper](https://arxiv.org/abs/2608.14391) · [Code](https://github.com/24029100313/RA-Bench)</sub> | Multimodal Perception | 280 HF votes · 87 GitHub stars |
...
| 4 | **ClawProBench**<br><sub>[Paper](http://arxiv.org/abs/2608.22510v1)</sub> | Knowledge & Reasoning | 2 HF votes · 822 GitHub stars |
| 5 | **SWE-bench Science**<br><sub>[Paper](https://arxiv.org/abs/2608.19799)</sub> | Coding & Software Engineering | 62 HF votes · 61 GitHub stars |
| 6 | **PlayWorld**<br><sub>[Paper](https://arxiv.org/abs/2608.13552) · [Code](https://github.com/kxding/PlayWorld)</sub> | Multimodal Perception | 46 HF votes · 87 GitHub stars |
| 7 | **SWE-Bench ProMax**<br><sub>[Paper](https://arxiv.org/abs/2608.09802)</sub> | Coding & Software Engineering | 133 HF votes · 600 dataset downloads |
| 8 | **VAKRA**<br><sub>[Paper](https://arxiv.org/abs/2608.12282) · [Code](https://github.com/IBM/VAKRA)</sub> | Knowledge & Reasoning | 65 GitHub stars · 1,748 dataset downloads |
| 9 | **CDAF — Cached Descriptive Asset Files**<br><sub>[Paper](https://github.com/UditAkhourii/cdaf) · [Code](https://github.com/UditAkhourii/cdaf)</sub> | Knowledge & Reasoning | 99 GitHub stars |
| 10 | **GDPevo**<br><sub>[Paper](https://arxiv.org/abs/2608.03764) · [Code](https://github.com/Prism-Shadow/GDPevo)</sub> | Knowledge & Reasoning | 27 HF votes · 61 GitHub stars |
