...
<sub>Updated 2026-08-29 · benchmarks first released in August 2026</sub>

| # | Benchmark | Field | Public signals |
|---:|---|---|---|
| 1 | **ASI-Bench**<br><sub>[Paper](https://arxiv.org/abs/2608.17271) · [Code](https://github.com/apexin-ai/ASI-Bench)</sub> | Agents | 62 HF votes · 273 GitHub stars · 2,772 dataset downloads |
| 2 | **RA-Bench**<br><sub>[Paper](https://arxiv.org/abs/2608.14391) · [Code](https://github.com/24029100313/RA-Bench)</sub> | Multimodal Perception | 280 HF votes · 86 GitHub stars |
...
| 6 | **ConceptEdit-Bench**<br><sub>[Paper](https://arxiv.org/abs/2608.16812) · [Code](https://github.com/inclusionAI/ConceptEdit)</sub> | Multimodal Perception | 49 HF votes · 34 GitHub stars |
| 7 | **CoinVE-Bench**<br><sub>[Paper](https://arxiv.org/abs/2608.17566) · [Code](https://github.com/coinve200k/CoinVE-200K)</sub> | Multimodal Perception | 15 HF votes · 28 GitHub stars · 7,059 dataset downloads |
...
| 10 | **PAST-Bench**<br><sub>[Paper](https://arxiv.org/abs/2608.04003) · [Code](https://github.com/Gen-Verse/PAST-Bench)</sub> | Knowledge & Reasoning | 34 HF votes · 24 GitHub stars |
