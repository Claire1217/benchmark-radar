...
| 2 | **ReactHuman**<br><sub>[Paper](https://arxiv.org/abs/2609.10895)</sub> | Other benchmark tasks | 51 HF votes · 567 dataset downloads |
| 3 | **OV-SGG-Bench**<br><sub>[Paper](https://arxiv.org/abs/2609.12552)</sub> | Other benchmark tasks | 4 HF votes · 210 GitHub stars |
| 4 | **WearableQA**<br><sub>[Paper](https://arxiv.org/abs/2609.05405)</sub> | Other benchmark tasks | 42 HF votes · 21 GitHub stars |
| 5 | **LifeSci-Harbor-Bench**<br><sub>[Paper](https://huggingface.co/datasets/mondaycake/lifesci-harbor-bench)</sub> | Coding Agents | 226 dataset downloads |
| 6 | **MM-ContextASR Bench**<br><sub>[Paper](https://huggingface.co/datasets/lilonghao/MM-ContextASR-Bench)</sub> | Other benchmark tasks | 120 dataset downloads |
...
| 8 | **WPS AI Benchmark**<br><sub>[Paper](https://huggingface.co/datasets/OurSecureFuture/wps-ai-benchmark-v6)</sub> | Other benchmark tasks | 90 dataset downloads |
...
| 10 | **CivBench**<br><sub>[Paper](https://arxiv.org/abs/2609.02459) · [Code](https://github.com/lmwilki/civ6-mcp)</sub> | Other benchmark tasks | 0 HF votes · 184 GitHub stars |

### Explore the library

| Agent research | Related research |
|---|---|
| [Coding Agents](https://benchmark-radar.com/#library?direction=coding-agents) · 126<br>[Computer Use](https://benchmark-radar.com/#library?direction=computer-use) · 46<br>[Deep Research & Web Search](https://benchmark-radar.com/#library?direction=search-research) · 35<br>[Tool Use](https://benchmark-radar.com/#library?direction=tool-use) · 82<br>[Agent Memory](https://benchmark-radar.com/#library?direction=agent-memory) · 26<br>[Multi-Agent Systems](https://benchmark-radar.com/#library?direction=multi-agent) · 16<br>[Personal & Enterprise Agents](https://benchmark-radar.com/#library?direction=personal-workplace) · 55<br>[Data Analysis Agents](https://benchmark-radar.com/#library?direction=data-analysis-agents) · 25<br>[AI Research Agents](https://benchmark-radar.com/#library?direction=ai-research-agents) · 21<br>[Self-Improving Agents](https://benchmark-radar.com/#library?direction=self-improving-agents) · 15<br>[Agent Harnesses & Skills](https://benchmark-radar.com/#library?direction=agent-harness-skills) · 9<br>[Agent Safety & Security](https://benchmark-radar.com/#library?direction=agent-safety-security) · 76<br>[AI for Science](https://benchmark-radar.com/#library?direction=scientific-agents) · 30 | [OCR & Document Understanding](https://benchmark-radar.com/#library?direction=ocr-documents) · 44<br>[Video Understanding](https://benchmark-radar.com/#library?direction=video-understanding) · 84<br>[Speech & Audio](https://benchmark-radar.com/#library?direction=realtime-multimodal) · 82<br>[World Models](https://benchmark-radar.com/#library?direction=world-models) · 19<br>[Embodied AI & VLA](https://benchmark-radar.com/#library?direction=embodied-vla) · 86<br>[Image & Video Generation](https://benchmark-radar.com/#library?direction=image-video-generation) · 69<br>[Efficient Inference](https://benchmark-radar.com/#library?direction=efficient-inference) · 11 |
