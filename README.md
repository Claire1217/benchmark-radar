...
|---:|---|---|---|
| 1 | **ReactHuman**<br><sub>[Paper](https://arxiv.org/abs/2609.10895)</sub> | Robotics & Embodied Intelligence | 327 dataset downloads |
...
| 4 | **EdgeMosaic**<br><sub>[Paper](https://github.com/michailfragkiskos/EdgeMosaic) · [Code](https://github.com/michailfragkiskos/EdgeMosaic)</sub> | Knowledge & Reasoning | 28 GitHub stars |
| 5 | **Φ-Bench**<br><sub>[Paper](https://arxiv.org/abs/2609.10226)</sub> | Coding & Software Engineering | 5 HF votes · 54 GitHub stars |
...
| 8 | **RoboSPA**<br><sub>[Paper](https://arxiv.org/abs/2609.05324) · [Code](https://github.com/fanzhenxuan/RoboSPA)</sub> | Robotics & Embodied Intelligence | 25 HF votes · 15 GitHub stars |
| 9 | **PNI-3D Multimodal CAD & Geometric Robustness Benchmark**<br><sub>[Paper](https://huggingface.co/datasets/tryforge/pni-3d-benchmark)</sub> | Knowledge & Reasoning | 18 dataset downloads |
| 10 | **VANTAGE-BENCH**<br><sub>[Paper](https://arxiv.org/abs/2609.09396)</sub> | Multimodal Perception | 3 HF votes · 2,292 dataset downloads |
...
**[Browse all 2,628 Library records →](https://benchmark-radar.com/#library)**
